...
class Educ(db.Model):
    ...
    inst=db.Column(db.String, default="")
    curso=db.Column(db.String, default="")
    anoin=db.Column(db.Integer, default=0)
    anoter=db.Column(db.Integer, default=0)
    descr=db.Column(db.Text, default="")
...
class Experiencia(db.Model):
    ...
    func=db.Column(db.String, default="")
    anoin=db.Column(db.Integer, default=0)
    anoter=db.Column(db.Integer, default=0)
    descr=db.Column(db.Text, default="")
...
class Horario(db.Model):
    ...
    prest_id=db.Column(db.Integer, db.ForeignKey("prest.id"))
...
class Prestador(db.Model):
    ...
    subclasse_id=db.Column(db.Integer, db.ForeignKey("subclasses.id"))
    prec=db.Column(db.Numeric)
...
class Sugest(db.Model):
    __tablename__='sugest'
    id=db.Column(db.Integer, primary_key=True)
